...
namespace Ranker
{
    public class Commands
    {
        ...
        public async static Task<MemoryStream> RankZeealeid(IRankerRepository _database, DiscordGuild guild, DiscordUser user, Rank rank)
        {
            ...
            var list = (await _database.Ranks.GetAsync(guild.Id)).OrderByDescending(f => f.TotalXp).ToList();

            int leader = list.IndexOf(list.FirstOrDefault(f => f.User == user.Id)) + 1;

            using Image<Rgba32> image = new(934, 282);
            ...
            TextOptions textOptions = new(font1)
            {
            ...
            TextOptions textOptions2 = new(font2)
            {
            ...
            TextOptions textOptions3 = new(font3)
            {
        ...
        public async static Task<MemoryStream> RankFleuron(IRankerRepository _database, DiscordGuild guild, DiscordUser user, Rank rank)
        {
            ...
            using var frontCard = new Image<Rgba32>(934, 242);
            ...
            TextOptions textOptions3 = new(font2)
            {
            ...
            TextOptions textOptions4 = new(font1)
            {
            ...
            TextOptions textOptions5 = new(font4);
